      ...
      <Layout>
        <>
          <Card description="Bug" imageCard={<img alt="" className="p-5" src="/bug.png" />}>
            <>
              <div className="text-center px-4">{toolDescription.Bug}</div>
          ...
          <Card description="Frog" imageCard={<img alt="" className="p-5" src="/frog.png" />}>
            <>
              <div className="text-center px-4">{toolDescription.Frog}</div>
              <div className="flex items-center justify-center my-5">
                <button
                  type="button"
                  className="flex justify-center items-center py-2 border border-transparent text-lg font-semibold rounded-xl shadow-sm text-black bg-white hover:bg-gray-200 w-28"
          ...
          <Card description="Dog" imageCard={<img alt="" className="p-5" src="/dog.png" />}>
            <>
              <div className="text-center">{toolDescription.Dog}</div>
              <div className="flex items-center justify-center my-5">
                <button
                  type="button"
                  className="flex justify-center items-center py-2 border border-transparent text-lg font-semibold rounded-xl shadow-sm text-black bg-white hover:bg-gray-200 w-28"
          ...
          >
            <>
              <div className="text-center px-4">{toolDescription.Toolkit}</div>
              <div className="flex flex-1 items-end justify-center my-5">
                <button
                  type="button"
                  className="flex justify-center items-center py-2 border border-transparent text-lg font-semibold rounded-xl shadow-sm text-black bg-white hover:bg-gray-200 w-28"
                  onClick={() =>
          ...
          >
            <>
              <div className="text-center px-4">{toolDescription.Oil}</div>
              <div className="flex items-center justify-center my-5">
                <button
                  type="button"
                  className="flex justify-center items-center py-2 border border-transparent text-lg font-semibold rounded-xl shadow-sm text-black bg-white hover:bg-gray-200 w-28"
