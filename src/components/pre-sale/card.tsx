...
export const Card = ({ total, bought, price, title, href }: CardProps) => (
  <div className="relative w-80 md:w-52 xl:w-80 2xl:w-96 h-80 md:h-60 xl:h-80 2xl:h-96 mx-auto text-tory-blue-500">
    ...
    <div className="p-5 flex flex-col place-content-between h-full ">
      <div className="pl-10 md:pl-5 xl:pl-10 flex justify-left font-extrabold text-3xl md:text-2xl 2xl:text-4xl text-mariner-500 z-10">
        {title}
      </div>
      ...
      <div className="flex ml-2 md:ml-0 2xl:ml-4 items-center justify-between mr-2 xl:mr-2 2xl:mr-4 z-10">
