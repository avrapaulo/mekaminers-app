...
import { robotFilterAtom, defaultRobotFilters } from 'recoil/atoms'
...
export const RobotFilters = () => {
  ...
  const [filters, setFilters] = useRecoilState(robotFilterAtom)
      ...
      <section aria-labelledby="filter-heading" className="py-6">
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            onClick={() => setFilters(defaultRobotFilters)}
          >
            Clear all
          </button>
          <button
